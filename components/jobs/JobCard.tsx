...
import { FaMapMarkerAlt, FaEllipsisV, FaBuilding, FaFire, FaBolt, FaLeaf, FaMicrophone, FaDollarSign, FaExternalLinkAlt, FaTimes, FaSquare, FaCopy, FaClone } from 'react-icons/fa';
